...
class Integrity(unittest.TestCase):
    def test_two_complete_previous_weeks(self):
        ...
        self.assertEqual(r['official_result']['place']['status'],'confirmed')
    ...
    def test_sales_not_dividends(self):
        self.assertEqual(payouts('연: 1,000,000\n배당률 단: ①2.0 연: ①1.2 ②2.0 ③4.1 복: ①②3.0',[1,2,3]),{'1':1.2,'2':2.,'3':4.1})
        self.assertEqual(payouts('배당률 단: ①2.0 연: ①1.2 ②2.0 복: ①②3.0',[1,2]),{'1':1.2,'2':2.})
    def test_missing_and_malformed_never_zero(self):
        for s in ['연: 1,000,000','배당률 단: ①2.0 연: ①1.2 복: ①②3.0','배당률 단: ①2.0 연: ①1.2 ②2.0 ③4.1 오류 복: ①②3.0','배당률 단: ①2.0 연: ①1.2 ②2.0 ③4.1 ①1.2 복: ①②3.0']:
